...
export default function VerifyDomainError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Verify-domain error boundary caught:', error)
  }, [error])
    ...
    <div className="min-h-screen bg-surface-secondary flex items-center justify-center p-4">
      <div className="bg-surface-elevated rounded-(card) shadow-md p-8 max-w-md w-full text-center">
        ...
        <p className="text-text-secondary mb-6">
          Something went wrong with the domain verification process. Please try again.
        </p>
